...
| M2 — dependency leaves | in progress | 37 of 96 production sources are modules; phase-neutral preview, asset, informal-block/group, traversal-domain, Rust-code, and graph models now pass strict module consumers |
