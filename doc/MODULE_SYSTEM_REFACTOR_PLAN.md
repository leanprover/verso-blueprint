...
| M2 — dependency leaves | in progress | 72 of 97 production sources are modules; phase-neutral preview, style/hover/Lean-link/code-preview/external-code/command-summary data and ordering/markup, manual-preview/source, informal-block/relation-panel/use-reference/inline-code/Rust-panel rendering, metadata data, asset-bundle, serialized command blocks, Lean/informal-block/graft-node configuration/storage/traversal/authoring and author/group/source authoring, typed traversal-store, Rust-code, and graph model/API modules now pass strict module consumers |
