...
| M2 — dependency leaves | in progress | 57 of 96 production sources are modules; phase-neutral preview, style/hover/Lean-link/code-preview/external-code summaries/markup, manual-preview/source and informal-block rendering, metadata data, asset-bundle, informal-block configuration/storage and group/source-metadata authoring, typed traversal-store, Rust-code, and graph model/API modules now pass strict module consumers |
