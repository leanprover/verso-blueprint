...
| M2 — dependency leaves | in progress | 48 of 96 production sources are modules; phase-neutral preview, style/hover/external-markup and metadata rendering data, asset-bundle, informal-block shared rendering/storage, group and source-metadata authoring, typed traversal-store, Rust-code, and graph models now pass strict module consumers |
