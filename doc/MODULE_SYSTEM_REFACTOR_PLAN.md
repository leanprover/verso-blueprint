...
| M2 — dependency leaves | in progress | 49 of 96 production sources are modules; phase-neutral preview, style/hover/external-markup and informal-block rendering, metadata data, asset-bundle, informal-block shared storage, group and source-metadata authoring, typed traversal-store, Rust-code, and graph models now pass strict module consumers |
