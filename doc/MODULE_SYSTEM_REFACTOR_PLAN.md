...
| M2 — dependency leaves | in progress | 55 of 96 production sources are modules; phase-neutral preview, style/hover/Lean-link/external-code summaries/markup, manual-preview/source and informal-block rendering, metadata data, asset-bundle, informal-block shared storage, group and source-metadata authoring, typed traversal-store, Rust-code, and graph model/API modules now pass strict module consumers |
