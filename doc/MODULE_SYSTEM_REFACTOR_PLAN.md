...
| M2 — dependency leaves | in progress | 60 of 96 production sources are modules; phase-neutral preview, style/hover/Lean-link/code-preview/external-code summaries/markup, manual-preview/source, informal-block and relation-panel rendering, metadata data, asset-bundle, Lean/informal-block configuration/storage/traversal and group/source-metadata authoring, typed traversal-store, Rust-code, and graph model/API modules now pass strict module consumers |
