...
| M2 — dependency leaves | in progress | 67 of 97 production sources are modules; phase-neutral preview, style/hover/Lean-link/code-preview/external-code summaries/markup, manual-preview/source, informal-block/relation-panel/use-reference/inline-code/Rust-panel rendering, metadata data, asset-bundle, Lean/informal-block configuration/storage/traversal/authoring and author/group/source-metadata authoring, typed traversal-store, Rust-code, and graph model/API modules now pass strict module consumers |
