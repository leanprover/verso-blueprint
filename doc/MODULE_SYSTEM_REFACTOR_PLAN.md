...
| M2 — dependency leaves | in progress | 50 of 96 production sources are modules; phase-neutral preview, style/hover/external-markup, manual-preview and informal-block rendering, metadata data, asset-bundle, informal-block shared storage, group and source-metadata authoring, typed traversal-store, Rust-code, and graph models now pass strict module consumers |
