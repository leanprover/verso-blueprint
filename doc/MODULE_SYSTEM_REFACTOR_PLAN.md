...
| M2 — dependency leaves | in progress | 42 of 96 production sources are modules; phase-neutral preview, hover-render, asset, informal-block shared rendering/storage, group authoring, typed traversal-store, Rust-code, and graph models now pass strict module consumers |
