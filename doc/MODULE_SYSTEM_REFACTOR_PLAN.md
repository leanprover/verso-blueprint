...
| M2 — dependency leaves | in progress | 38 of 96 production sources are modules; phase-neutral preview, asset, informal-block/group, typed traversal-store, Rust-code, and graph models now pass strict module consumers |
