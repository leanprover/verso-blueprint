...
| M2 — dependency leaves | in progress | 36 of 96 production sources are modules; phase-neutral preview, asset, informal-block/group, traversal-domain, and Rust-code models now pass strict module consumers |
