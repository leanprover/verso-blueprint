...
| M2 — dependency leaves | in progress | 28 of 95 production sources are modules; the `@[blueprint]` attribute and shared label-argument parser now pass strict meta consumers in addition to the converted math and runtime leaves |
