...
| M2 — dependency leaves | in progress | 43 of 96 production sources are modules; phase-neutral preview, hover-render, asset, informal-block shared rendering/storage, group and source-metadata authoring, typed traversal-store, Rust-code, and graph models now pass strict module consumers |
