...
| M2 — dependency leaves | in progress | 40 of 96 production sources are modules; phase-neutral preview, hover-render, asset, informal-block/group/storage, typed traversal-store, Rust-code, and graph models now pass strict module consumers |
