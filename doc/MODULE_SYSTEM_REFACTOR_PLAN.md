...
| M2 — dependency leaves | in progress | 41 of 96 production sources are modules; phase-neutral preview, hover-render, asset, informal-block/group authoring and storage, typed traversal-store, Rust-code, and graph models now pass strict module consumers |
