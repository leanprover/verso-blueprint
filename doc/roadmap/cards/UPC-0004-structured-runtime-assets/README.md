...
Removal target: ad hoc asset assembly and owner-module invalidation rules
...
Blueprint must embed assets through package-owned Lean modules and maintain
local freshness rules for those embedded files.
...
- Local pressure points: Blueprint `-verso-data/` writers and browser runtime
  entrypoints.
- Local workaround: package-owned Lean modules that embed static browser files.
